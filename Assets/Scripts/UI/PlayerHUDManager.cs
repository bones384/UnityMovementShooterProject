...
public class PlayerHUDManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        PlayerStateComponent state = PlayerVisualisationManager.LocalPlayer.Value;
    ...
    private void UpdateHealth(float currentHealth)
    {
        ...
        float safeHealth = Mathf.Clamp(currentHealth, 0f, MAX_HEALTH);
        float healthPercent = (safeHealth / MAX_HEALTH) * 100f;
