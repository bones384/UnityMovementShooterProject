...
namespace Unity.Physics.Authoring
{
    static partial class PhysicsShapeExtensions
    {
        ...
        public static void SetBakedSphereRadius(this PhysicsShapeAuthoring shape, float radius)
        {
            ...
            var bakeToShape = Math.GetPrimitiveBakeToShapeMatrix(shape.transform.localToWorldMatrix,
                shape.GetShapeToWorldMatrix(), ref center, ref orientation, basisPriority);
